...
try {
    ...
    //echo "Connected successfully DNHOSPITAL";
    // $_SESSION['success'] = "PDO Connected Databas: '" . $dbName . "' is successfully";
    $_SESSION['success'] = "PDO Connected Databas: connHos is successfully";
} catch (PDOException $e) {
    // echo "Connection failed: " . $e->getMessage();
    // $_SESSION['errorS'] = "PDO Connection Databas: '" . $dbName . "' is failed: " . $e->getMessage();
    $_SESSION['errorS'] = "PDO Connection Databas: connHos is failed: " . $e->getMessage();
}
