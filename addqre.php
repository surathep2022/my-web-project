...
include 'condb.php'; // ให้ include ไฟล์ที่มีการเชื่อมต่อกับฐานข้อมูล
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['vn']) && isset($_POST['payment_slot'])) {
        ...
        try {
            ...
            // ลบข้อมูลจากตาราง req_table โดยอ้างอิงจาก VN
            $sql_delete = "DELETE FROM req_table WHERE vn = :vn";
            $stmt_delete = $conn->prepare($sql_delete);
            $stmt_delete->bindParam(':vn', $vn);
            $stmt_delete->execute();

            // Redirect ไปที่หน้า callqmoney.php
            session_start();
        ...
        <script>
            ...
            window.location.href = 'callqmoney.php';
        </script>";
    }
}
?>
