...
<meta http-equiv="refresh" content="5;URL=iframe4.php">
...
<script>
    setInterval(function(){
        document.querySelector("iframe").src = "iframe4.php"; // รีโหลด iframe
...
try {
    ...
    $sql = "SELECT * FROM paymentq WHERE payment_slot = 4 ORDER BY created_at DESC LIMIT 1"; // ดึงข้อมูลที่มี payment_slot = 1  และเรียงตาม created_at ล่าสุด
